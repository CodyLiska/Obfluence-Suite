...
> This index provides a structured overview of internal knowledge assets, including reference guides, schemas, data maps, and technical how-tos. Folder contents and descriptions are pulled dynamically from frontmatter where available.

```dataviewjs
const root = "DEVELOPMENT_WIKI/07_Knowledge Base";
